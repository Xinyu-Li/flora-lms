...
function local_boostnavigation_extend_navigation(global_navigation $navigation) {
    ...
    if (isset($config->insertcustomnodesusers) && (($COURSE->id == 13)|| ($COURSE->id == 13)) && !empty($config->insertcustomnodesusers)) {
        // If yes, do it.
    ...
    if (isset($config->insertcustomcoursenodesusers) && (($COURSE->id == 2)|| ($COURSE->id == 2)) && !empty($config->insertcustomcoursenodesusers)) {
        // Only proceed if we are inside a course and we are _not_ on the frontpage.
        if ($PAGE->context->get_course_context(false) == true && $COURSE->id != SITEID && $coursehomenode) {
            // If yes, do it.
    ...
    if (isset($config->insertcustombottomnodesusers) && (($COURSE->id == 3)|| ($COURSE->id == 3))&& !empty($config->insertcustombottomnodesusers)) {
        // If yes, do it.
