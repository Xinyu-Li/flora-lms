...
function local_boostnavigation_extend_navigation(global_navigation $navigation) {
    ...
    if (isset($config->insertcustomnodesusers) && ($COURSE->id == $CFG->MainCourse_ID) && !empty($config->insertcustomnodesusers)) {
        // If yes, do it.
    ...
    if (isset($config->insertcustomcoursenodesusers) && ($COURSE->id == $CFG->MainCourse_ID) && !empty($config->insertcustomcoursenodesusers)) {
        // Only proceed if we are inside a course and we are _not_ on the frontpage.
        if ($PAGE->context->get_course_context(false) == true && $COURSE->id != SITEID && $coursehomenode) {
            // If yes, do it.
    ...
    if (isset($config->insertcustomcoursenodesadmins) && ($COURSE->id == $CFG->TrainingCourse_ID) &&  !empty($config->insertcustomcoursenodesadmins) && !is_siteadmin()) {
        // Only proceed if we are inside a course and we are _not_ on the frontpage.
        if ($PAGE->context->get_course_context(false) == true && $COURSE->id != SITEID) {
            // If yes, do it.
    ...
    if (isset($config->insertcustombottomnodesusers) && ($COURSE->id == $CFG->MainCourse_ID) && !empty($config->insertcustombottomnodesusers)) {
        // If yes, do it.
